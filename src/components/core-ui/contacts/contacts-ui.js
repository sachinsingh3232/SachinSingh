...
import { FaGithub, FaLinkedinIn, FaMediumM, FaStackOverflow, FaInstagram, FaYoutube } from 'react-icons/fa';
            ...
            <div className='socialmedia-icons'>
              ...
              {contactsData.gfg && (
                <a
                  ...
                  className={classes.socialIcon}
                >
                  <SiGeeksforgeeks aria-label='Medium' />
                </a>
              )}
              ...
              {contactsData.leetcode && (
                <a
                  ...
                  className={classes.socialIcon}
                >
                  <TbBrandLeetcode aria-label='facebook' />
                </a>
              )}
            </div>
          </div>
